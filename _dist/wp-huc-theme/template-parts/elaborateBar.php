...
<div class="bgLightGrey">
  <div class="elaborateBar hcBasicSideMargin">
    ...
    <?php  if (get_theme_mod('ElaborateAproved', false)) { ?>
    <div class="elaborateHuygensApproved">
      <span>Approved by <a href="https://www.huygens.knaw.nl" target="_blank" ></span>
      <img src="<?php echo get_bloginfo( 'template_url' ); ?>/images/logo-huygens-ing.png"></a>
    </div>
    <?php } ?>
